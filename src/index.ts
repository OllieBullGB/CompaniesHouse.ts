...
import { Address, AppointmentSearchOptions, Company, CompanyOfficers, Officer, OfficerAppointment, OfficerSearchOptions } from "./Types";
...
class Officers
{
    ...
    async getCompanyOfficers(companyNumber: string, options:OfficerSearchOptions): Promise<CompanyOfficers>
    {
